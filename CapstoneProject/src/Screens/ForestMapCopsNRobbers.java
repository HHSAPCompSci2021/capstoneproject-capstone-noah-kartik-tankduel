...
/**
 * The cops and robbers game mode for the forest map
 * @author Noah Pien and Kartik Joshi
 */
public class ForestMapCopsNRobbers extends Screens implements NetworkListener{
	...
	/**
	 * Sets up the forest map cops and robbers screens 
